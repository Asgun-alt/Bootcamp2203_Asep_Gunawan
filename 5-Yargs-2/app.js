...
// command to see list of information from json file
yargs.command({
    command: 'list',
...
// commmand to see detail information from contact.json file
yargs.command({
    command: 'detail',
...
// command to delete data from contacts.json file
yargs.command({
    command: 'delete',
